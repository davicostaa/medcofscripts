document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('loginForm').addEventListener('submit', function(event) {
        ...
        if (username && password) {
            ...
            container.classList.add('hidden'); // Mostra o campo de mensagens personalizadas
            frequente.classList.add('hidden');
            logo.classList.add('hidden');
            page.classList.remove('hidden')
            seção.classList.remove('hidden');
            
            document.querySelector('.login-container').classList.add('hidden'); // Esconde o formulário de login
        } else {
